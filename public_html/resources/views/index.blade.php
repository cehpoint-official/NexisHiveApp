    ...
    <div class="dashboard-cards">
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('users') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('posts') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('rooms') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('notifications') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('interests') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('verificationRequests') }}</h4>
        ...
        <div class="dashboard-blog">
            ...
            <div class="dashboard-blog-content">
                <h4 class="fw-normal">{{ __('reports') }}</h4>
