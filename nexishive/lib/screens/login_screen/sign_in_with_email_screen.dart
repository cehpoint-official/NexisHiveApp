    ...
    return SafeArea(
      ...
      child: ClipSmoothRect(
        radius: const SmoothBorderRadius.only(
            topRight: SmoothRadius(cornerRadius: 12, cornerSmoothing: cornerSmoothing),
            topLeft: SmoothRadius(cornerRadius: 12, cornerSmoothing: cornerSmoothing)),
        child: Container(
          color: Colors.white,
          child: Column(
            children: [
    ...
    return Container(
      ...
      child: Column(
        children: [
              ...
              onTap: () async {
                ...
                try {
                  ...
                  if (credential.user?.emailVerified == true) {
                    Get.back();
                    widget.onSubmit(
                        fullNameController.text == "" ? null : fullNameController.text, emailController.text);
                  } else {
          ...
          Row(
            children: [
              LKeys.doNtHaveAnAccount.toTextTR(MyTextStyle.gilroyLight(color: cLightText, size: 12)),
              ...
              GestureDetector(
                onTap: showForgot,
                child: LKeys.forgotPassword.toTextTR(MyTextStyle.gilroySemiBold(color: cBlack, size: 12)),
              ),
            ],
          )
        ],
